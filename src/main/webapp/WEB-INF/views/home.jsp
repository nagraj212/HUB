		...
		<div class="shell">
			...
			<div class="container">
				...
				<ul>
					...
					<li><a href="../hub/home/java">Java & JEE</a></li>
					<li><a href="../hub/home/frame">Frameworks</a></li>
					<li><a href="../hub/home/web">Web Design</a></li>
					<li><a href="../hub/home/webnair">Webnair</a></li>
					<li><a href="../hub/home/others">Others</a></li>
					<li><a href="../hub/home/user">User Name</a></li>
				</ul>
				</nav>
				<!-- end of navigation -->
				<!-- slider -->
							...
							<ul class="slides">
								<li>
									...
									<div class="slide-cnt">
										...
										<a href="../hub/home/tutorial" class="grey-btn">Have a look..</a>
									</div>
								</li>
								<li>
									<div class="img-holder">
									...
									<div class="slide-cnt">
										...
										<a href="../hub/home/ebooks" class="grey-btn">Have a look..</a>
									</div>
								</li>
								<li>
									<div class="img-holder">
									...
									<div class="slide-cnt">
										...
										<a href="../hub/home/youtube" class="grey-btn">Have a look..</a>
									</div>
								</li>
							</ul>
						</div>
